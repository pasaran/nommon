...
function s_index( data, root, vars, value, expr, next ) {
    ...
    var new_data = ( is_array( data ) ) ? data.concat() : Object.assign( {}, data );
...
function g_index( data, root, vars, expr ) {
    ...
    if ( is_array( data ) && typeof index !== 'number' ) {
...
var FUNCTIONS = {
    ...
    length: function( value ) {
        if ( is_array( value ) || typeof value === 'string' ) {
            return value.length;
        }
