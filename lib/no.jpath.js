...
var scheme_default = no.Scheme.default;
var scheme_scalar = no.Scheme.scalar;
var scheme_string = no.Scheme.string;
var scheme_number = no.Scheme.number;
var scheme_boolean = no.Scheme.boolean;
...
runtime.M = no.Scheme.get_method_body;
runtime.j = _jpaths;
...
no.jpath.defunc = function( name, def ) {
    ...
    if ( typeof def === 'function' ) {
        ...
        scheme = no.Scheme.get( def.scheme ) || scheme_default;
        body = def.body;
    }
